...
void subscription_callback_interface(const void * msgin)
{
	const std_msgs__msg__Float32MultiArray * msg = (const std_msgs__msg__Float32MultiArray*)msgin;
	cmd_spin = msg->data.data[3];
